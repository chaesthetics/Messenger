...
export default function homepage() {
    ...
    const handleActiveConvo = (convoId: any) => {
        ...
        for (var i = 0; i < len; i++) {
            (convos[i] as HTMLElement).style.backgroundColor = "white";
        }
        const selectedConvo = document.getElementById(convoId);
        if (selectedConvo) {
            (selectedConvo as HTMLElement).style.backgroundColor = "rgb(243 244 246)";
        }
    }
    ...
    return (
        <div className="h-screen w-screen grid grid-cols-12 overflow-hidden">
            <div className="grid grid-cols-7 sideBar col-span-4 border-r-[1px] border-gray-200">
                <SideBar />
                <div className="w-full h-screen col-span-6 overflow-y-auto pb-2">
                        ...
                        {chatList.map((chat, index) => {
                            ...
                            return (
                                <div
                                    ...
                                    onPointerDown={() => handleActiveConvo(chat.id)}
                                    className="conversations flex mt-2 w-[370px] py-2 px-3 hover:bg-gray-100 hover:cursor-pointer duration-300 transition-300 animation-300 rounded-md space-x-4 items-center"
                                >
                                    <Image
                                        src={
