...
export default function homepage() {
    ...
    return (
        <div className="h-screen w-screen flex grid-cols-12 overflow-hidden">
                    ...
                    <div className="relative flex flex-col w-full items-center">
                        ...
                        {chatList.map((chat, index) => {
                            ...
                            return (
                                <div
                                    key={key}
                                    onClick={() => handleConvoSelection(chat)}
                                    className={`conversations flex mt-2 w-[370px] py-2 px-3 hover:bg-gray-100 hover:cursor-pointer duration-300 transition-300 animation-300 rounded-md space-x-4 items-center ${chat?.id == selectedConvo.id ? "bg-gray-100" : ""}`}
                                >
                                    <Image
                                        src={
                                            chat?.chatwith?.avatar === null
                                                ? "data:image/jpeg;base64,"
                                                : chat?.chatwith?.avatar
                                        }
                                        width={50}
                                        height={50}
                                        alt="profile"
            ...
            <div className="mainBar col-span-11 w-full h-screen flex flex-col overflow-x-scroll">
                <div className="flex h-[60px] min-h-[60px] border-b-[1px] bg-white shadow-sm px-2 items-center justify-between">
                    <div className="flex space-x-2 items-center hover:bg-gray-100 px-2 py-2 hover:cursor-pointer transition-200 duration-300 animation-300 rounded-md">
                        <Image
                            src={selectedConvo?.chatwith?.avatar ? selectedConvo?.chatwith?.avatar : "data:image/jpeg;base64,"}
                            width={35}
                            height={35}
                            alt="profile"
                ...
                <div className="flex flex-col h-full justify-between">
                    <div className="flex w-full justify-between pt-12 flex-col h-full overflow-y-scroll scroll-smooth pb-4">
                        <div className="flex items-center mt-10 flex-col pb-6 px-2">
                            <Image
                                src={selectedConvo?.chatwith?.avatar ? selectedConvo?.chatwith?.avatar : "data:image/jpeg;base64,"}
                                width={60}
                                height={60}
                            ...
                            <p className="text-xs text-center font-semibold text-gray-700 mt-16">You can now message and call each other and see info like Active Status and when</p>
                            <p className="text-xs text-center font-semibold text-gray-700">you've read messages.</p>
                        </div>
                        {
                    ...
                    <form onSubmit={handleChat} className="sticky bottom-0 h-[54px] flex justify-between items-center bg-white px-2 pl-4 pr-6">
                        <div className="flex items-center space-x-2 w-full">
                            <div className="flex hover:bg-gray-200 hover:cursor-pointer transition-200 duration-300 animation-300 rounded-full h-[34px] w-[34px] items-center justify-center">
                                <svg className="x1lliihq x1rdy4ex xcud41i x4vbgl9 x139jcc6 x1k90msu x11xpdln x1qfuztq xsrhx6k x7p49u4" fill="#be123c" height="30px" viewBox="0 0 36 36" width="30px"><path clipRule="evenodd" d="M18 29c6.075 0 11-4.925 11-11S24.075 7 18 7 7 11.925 7 18s4.925 11 11 11zm-1-16a1 1 0 112 0v3.75c0 .138.112.25.25.25H23a1 1 0 110 2h-3.75a.25.25 0 00-.25.25V23a1 1 0 11-2 0v-3.75a.25.25 0 00-.25-.25H13a1 1 0 110-2h3.75a.25.25 0 00.25-.25V13z" fill="var(--chat-composer-button-color)" fillRule="evenodd"></path></svg>
                            </div>
                            <div className="flex hover:bg-gray-200 hover:cursor-pointer transition-200 duration-300 animation-300 rounded-full h-[34px] w-[34px] items-center justify-center">
                                <svg className="x1lliihq x1rdy4ex xcud41i x4vbgl9 x139jcc6 xsrhx6k" fill="#be123c" height="30px" viewBox="0 0 36 36" width="30px"><path d="M13.5 16.5a2 2 0 100-4 2 2 0 000 4z" fill="var(--chat-composer-button-color)"></path><path clipRule="evenodd" d="M7 12v12a4 4 0 004 4h14a4 4 0 004-4V12a4 4 0 00-4-4H11a4 4 0 00-4 4zm18-1.5H11A1.5 1.5 0 009.5 12v9.546a.25.25 0 00.375.217L15 18.803a6 6 0 016 0l5.125 2.96a.25.25 0 00.375-.217V12a1.5 1.5 0 00-1.5-1.5z" fill="var(--chat-composer-button-color)" fillRule="evenodd"></path></svg>
                            </div>
                            <div className="flex hover:bg-gray-200 hover:cursor-pointer transition-200 duration-300 animation-300 rounded-full h-[34px] w-[34px] items-center justify-center">
